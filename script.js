...
async function loadfacts() {
  const res = await fetch(
    "https://hmnofguqmdluxveozuhz.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imhtbm9mZ3VxbWRsdXh2ZW96dWh6Iiwicm9sZSI6ImFub24iLCJpYXQiOjE2NzQ5MTQzODMsImV4cCI6MTk5MDQ5MDM4M30.pwTg8TGCVvCJFKc4sdkHRZz97nralaPWQAIuizDjrp4 ",
      },
    }
  );
